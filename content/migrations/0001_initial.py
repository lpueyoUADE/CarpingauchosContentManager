# Generated by Django 5.2.4 on 2025-10-03 01:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', models.CharField(help_text='Texto identificador del recurso.', max_length=150)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', models.CharField(help_text='Texto identificador del recurso.', max_length=150)),
                ('key', models.SlugField(help_text='Texto autogenerado.', max_length=150, unique=True)),
                ('part_id', models.IntegerField(default=1, unique=True, validators=[django.core.validators.MinValueValidator(1)])),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mesh_path', models.TextField(blank=True, default='', null=True)),
                ('type', models.CharField(choices=[('weapon', 'Weapon'), ('equipment', 'Equipment'), ('consumable', 'Consumable'), ('quest_item', 'Quest Item')], max_length=20)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', models.CharField(help_text='Texto identificador del recurso.', max_length=150)),
                ('key', models.SlugField(help_text='Texto autogenerado.', max_length=150, unique=True)),
                ('type', models.CharField(choices=[('basic', 'Basic'), ('quest_prompt', 'Quest_Prompt'), ('quest_end', 'Quest_End')], max_length=20)),
                ...
                ('trigger_diary_conditions', models.ManyToManyField(blank=True, related_name='diaries_to_trigger', to='content.condition')),
                ('trigger_id_conditions', models.ManyToManyField(blank=True, related_name='ids_to_trigger', to='content.condition')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', models.CharField(help_text='Texto identificador del recurso.', max_length=150)),
                ('key', models.SlugField(help_text='Texto autogenerado.', max_length=150, unique=True)),
                ('appear_conditions', models.ManyToManyField(blank=True, related_name='diarypage_to_appear', to='content.condition')),
                ('name', content.models.LocalizedField(help_text='Texto Localizado.', on_delete=django.db.models.deletion.CASCADE, related_name='diarypage_name', to='content.localization')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('armor_physical_resistance', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('armor_magical_resistance', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('cooldown', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('duration', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('cost_health', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('cost_mana', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('cost_stamina', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('give_health', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('give_mana', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('give_stamina', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('buff_health_percent', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('buff_mana_percent', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('buff_stamina_percent', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('buff_physical_damage_percent', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('buff_magical_damage_percent', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('buff_stamina_regeneration_percent', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('nerf_physical_damage_percent', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('nerf_magical_damage_percent', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('nerf_extra_physical_damage_received_percent', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('nerf_extra_magical_damage_received_percent', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('item', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='itemattributes_item', to='content.item')),
            ],
        ),
        migrations.CreateModel(
            name='ItemReward',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', models.CharField(help_text='Texto identificador del recurso.', max_length=150)),
                ('key', models.SlugField(help_text='Texto autogenerado.', max_length=150, unique=True)),
                ('appear_conditions', models.ManyToManyField(blank=True, related_name='diaryentry_to_appear', to='content.condition')),
                ('diary_page', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='entries', to='content.diarypage')),
                ('text', content.models.LocalizedField(help_text='Texto Localizado.', on_delete=django.db.models.deletion.CASCADE, related_name='diaryentry_text', to='content.localization')),
                ('title', content.models.LocalizedField(help_text='Texto Localizado.', on_delete=django.db.models.deletion.CASCADE, related_name='diaryentry_title', to='content.localization')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='DialogueSingleItem',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('identifier', models.CharField(help_text='Texto identificador del recurso.', max_length=150)),
                ('key', models.SlugField(help_text='Texto autogenerado.', max_length=150, unique=True)),
                ('speaker', models.BooleanField(default=True, help_text='False es NPC, True es Player.')),
                ('text', content.models.LocalizedField(help_text='Texto Localizado.', on_delete=django.db.models.deletion.CASCADE, related_name='dialogue_single_item_text', to='content.localization')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.SlugField(help_text='Texto autogenerado.', max_length=150, unique=True)),
                ('speaker', models.BooleanField(default=True, help_text='False es NPC, True es Player.')),
                ('index', models.PositiveIntegerField(default=1, help_text='Orden del diálogo', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(1000)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', models.CharField(help_text='Texto identificador del recurso.', max_length=150)),
                ('key', models.SlugField(help_text='Texto autogenerado.', max_length=150, unique=True)),
                ('damage_type_id', models.IntegerField(default=0, unique=True, validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trigger_conditions', models.ManyToManyField(blank=True, related_name='poi_conditions_to_trigger', to='content.condition')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quest', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='quest_end_dialogue_quest', to='content.quest')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('acccept_text', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='quest_prompt_dialogue_accept_text', to='content.dialoguesingleitem')),
                ('deny_text', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='quest_prompt_dialogue_deny_text', to='content.dialoguesingleitem')),
                ...
                ('quest', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='quest_prompt_dialogue_quest', to='content.quest')),
                ('text', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='quest_prompt_dialogue_text', to='content.dialoguesingleitem')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', models.CharField(help_text='Texto identificador del recurso.', max_length=150)),
                ('key', models.SlugField(help_text='Texto autogenerado.', max_length=150, unique=True)),
                ('rarity_json_id', models.IntegerField(default=0, unique=True, validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('physical_damage_absorption_while_blocking', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('magical_damage_absorption_while_blocking', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('prefab', models.TextField(blank=True, default='', null=True)),
        ...
        migrations.AddField(
            model_name='weapon',
            name='weapon_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='weapon_type', to='content.weapontype'),
        ),
    ]
